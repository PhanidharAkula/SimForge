#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for New York City (5M trips).

City:   New York City, NY — Manhattan and surrounding area
Trips:  5,000,000 OD pairs
Scope:  ~40 km radius covering the NYC metropolitan area
...
CITY_KEY        = "nyc"
SCENARIO_ID     = "nyc_5m"
DESCRIPTION     = "New York City — 5M trip tier"

CENTER_LAT      = 40.758
CENTER_LON      = -73.9855
RADIUS_KM       = 40.0          # metro-wide coverage; requires WGTP expansion above ~1.1M raw car trips
