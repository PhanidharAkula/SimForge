#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for Los Angeles (500K trips).

City:   Los Angeles, CA — downtown and surrounding urban area
Trips:  500,000 OD pairs
Scope:  ~20 km radius covering LA basin from Santa Monica to Alhambra
...
Usage:
  python scripts/generate_la_500k.py                              # synthetic demand
  python scripts/generate_la_500k.py --model la_model.txt  # census demand
  python scripts/generate_la_500k.py --model la_model.txt --demand-only

Output: scenarios/la_500k/
"""
...
CITY_KEY        = "la"
SCENARIO_ID     = "la_500k"
DESCRIPTION     = "Los Angeles — 500K trip tier"

CENTER_LAT      = 34.0522
CENTER_LON      = -118.2437
RADIUS_KM       = 20.0          # full metro core for 500K trips
