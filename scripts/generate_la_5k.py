#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for Los Angeles (5K trips).

City:   Los Angeles, CA — downtown and surrounding urban area
Trips:  5,000 OD pairs
Scope:  ~5.0 km radius covering Downtown LA, Koreatown, Echo Park, Arts District
...
Usage:
  python scripts/generate_la_5k.py                              # synthetic demand
  python scripts/generate_la_5k.py --model la_model.txt  # census demand
  python scripts/generate_la_5k.py --model la_model.txt --demand-only

Output: scenarios/la_5k/
"""
...
CITY_KEY        = "la"
SCENARIO_ID     = "la_5k"
DESCRIPTION     = "Los Angeles urban area — 5K trip tier"

CENTER_LAT      = 34.0522
CENTER_LON      = -118.2437
RADIUS_KM       = 5.0          # LA is sprawling; wider radius needed
