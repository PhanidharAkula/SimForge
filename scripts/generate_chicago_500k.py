#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for Chicago (500K trips).

City:   Chicago, IL — full urban core
Trips:  500,000 OD pairs
Scope:  ~18 km radius covering Chicago city limits and inner suburbs
...
Usage:
  python scripts/generate_chicago_500k.py                              # synthetic demand
  python scripts/generate_chicago_500k.py --model chicago_model.txt  # census demand
  python scripts/generate_chicago_500k.py --model chicago_model.txt --demand-only

Output: scenarios/chicago_500k/
"""
...
# ---------------------------------------------------------------------------
CITY_KEY        = "chicago"
SCENARIO_ID     = "chicago_500k"
DESCRIPTION     = "Chicago — 500K trip tier"

CENTER_LAT      = 41.8781
CENTER_LON      = -87.6298
RADIUS_KM       = 18.0          # city-wide coverage for 500K trips
