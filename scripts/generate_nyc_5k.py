#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for New York City (5K trips).

City:   New York City — Manhattan and surrounding area
Trips:  5,000 OD pairs
Scope:  ~3.0 km radius covering Midtown, Downtown, East/West sides
...
Usage:
  python scripts/generate_nyc_5k.py                              # synthetic demand
  python scripts/generate_nyc_5k.py --model nyc_model.txt  # census demand
  python scripts/generate_nyc_5k.py --model nyc_model.txt --demand-only

Output: scenarios/nyc_5k/
"""
...
CITY_KEY        = "nyc"
SCENARIO_ID     = "nyc_5k"
DESCRIPTION     = "New York City — Manhattan and surroundings — 5K trip tier"

CENTER_LAT      = 40.7580
CENTER_LON      = -73.9855
RADIUS_KM       = 3.0          # covers most of Manhattan
