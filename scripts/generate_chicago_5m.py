#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for Chicago (5M trips).

City:   Chicago, IL — full urban core
Trips:  5,000,000 OD pairs
Scope:  ~45 km radius covering the Chicago metropolitan area
...
Usage:
  python scripts/generate_chicago_5m.py                              # synthetic demand
  python scripts/generate_chicago_5m.py --model chicago_model.txt  # census demand
  python scripts/generate_chicago_5m.py --model chicago_model.txt --demand-only

Output: scenarios/chicago_5m/
"""
...
# ---------------------------------------------------------------------------
CITY_KEY        = "chicago"
SCENARIO_ID     = "chicago_5m"
DESCRIPTION     = "Chicago — 5M trip tier"

CENTER_LAT      = 41.8781
CENTER_LON      = -87.6298
RADIUS_KM       = 45.0          # metro-wide; requires WGTP expansion or all-mode demand
