#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for Chicago (50K trips).

City:   Chicago, IL — full urban core
Trips:  50,000 OD pairs
Scope:  ~8 km radius covering the Loop, Lincoln Park, Hyde Park, Pilsen
...
Usage:
  python scripts/generate_chicago_50k.py                              # synthetic demand
  python scripts/generate_chicago_50k.py --model chicago_model.txt  # census demand
  python scripts/generate_chicago_50k.py --model chicago_model.txt --demand-only

Output: scenarios/chicago_50k/
"""
...
# ---------------------------------------------------------------------------
CITY_KEY        = "chicago"
SCENARIO_ID     = "chicago_50k"
DESCRIPTION     = "Chicago — 50K trip tier"

CENTER_LAT      = 41.8781
CENTER_LON      = -87.6298
RADIUS_KM       = 8.0          # broader urban core for 50K trips
