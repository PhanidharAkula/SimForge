#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for Los Angeles (50K trips).

City:   Los Angeles, CA — downtown and surrounding urban area
Trips:  50,000 OD pairs
Scope:  ~10 km radius covering greater Downtown LA, Hollywood, Inglewood, Pasadena
...
Usage:
  python scripts/generate_la_50k.py                              # synthetic demand
  python scripts/generate_la_50k.py --model la_model.txt  # census demand
  python scripts/generate_la_50k.py --model la_model.txt --demand-only

Output: scenarios/la_50k/
"""
...
CITY_KEY        = "la"
SCENARIO_ID     = "la_50k"
DESCRIPTION     = "Los Angeles — 50K trip tier"

CENTER_LAT      = 34.0522
CENTER_LON      = -118.2437
RADIUS_KM       = 10.0          # 10× trips needs wider metro area
