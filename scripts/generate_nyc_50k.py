#!/usr/bin/env python3
"""
Generate a canonical scenario bundle for New York City (50K trips).

City:   New York City, NY — Manhattan and surrounding area
Trips:  50,000 OD pairs
Scope:  ~7 km radius covering Manhattan, parts of Brooklyn and Queens
...
Usage:
  python scripts/generate_nyc_50k.py                              # synthetic demand
  python scripts/generate_nyc_50k.py --model nyc_model.txt  # census demand
  python scripts/generate_nyc_50k.py --model nyc_model.txt --demand-only

Output: scenarios/nyc_50k/
"""
...
CITY_KEY        = "nyc"
SCENARIO_ID     = "nyc_50k"
DESCRIPTION     = "New York City — 50K trip tier"

CENTER_LAT      = 40.758
CENTER_LON      = -73.9855
RADIUS_KM       = 7.0          # wider than Midtown to support 50K trips

NUM_TRIPS       = 50_000
SEED            = 42
HORIZON_START   = 0
HORIZON_END     = 7200          # 2-hour AM peak window
