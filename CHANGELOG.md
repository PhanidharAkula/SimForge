...
- **Engine-status staleness cleared:** ENGINE_COMPARISON and THIRD_ENGINE_OPTIONS no longer present DTALite as "pending"; LPSIM_EVALUATION's "code retained" claim corrected to the actual Version_5 removal.
...
- `doc/engines/LPSIM_EVALUATION.md`, full narrative of LPSim integration, the five failure classes (4 resolved, GPU kernel SIGSEGV unresolved), and why the abandonment frames as evidence FOR SimForge's adapter pattern
