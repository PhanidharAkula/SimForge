...
def chicago_bundle(tmp_path: Path) -> Path:
    ...
    (bundle / "network.xml").write_text(
        ...
        "<network>\n"
        "  <nodes>\n"
        "    <node id='n1' x='-87.6' y='41.88' type='intersection'/>\n"
        "    <node id='n2' x='-87.62' y='41.88' type='intersection'/>\n"
        "    <node id='n3' x='-87.6' y='41.89' type='intersection'/>\n"
        "    <node id='n4' x='-87.62' y='41.89' type='intersection'/>\n"
        "  </nodes>\n"
        "  <links>\n"
        "    <link id='l1' from='n1' to='n2' length='10' lanes='2' speed_limit='13.9' highway_type='primary'/>\n"
        "    <link id='l2' from='n2' to='n3' length='10' lanes='1' speed_limit='13.9' highway_type='residential'/>\n"
        "    <link id='l3' from='n3' to='n4' length='10' lanes='1' speed_limit='13.9' highway_type='footway'/>\n"
        "  </links>\n"
        "</network>\n",
        encoding="utf-8",
    )
