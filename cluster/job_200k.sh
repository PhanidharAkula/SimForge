#!/bin/bash
# ==============================================================
# SimForge — 200K Chicago Scenario Generation (Slurm Job)
# ==============================================================
# Generates: chicago_200k_car_transit (200K trips, car+transit, 24h)
#
# Submit:    sbatch cluster/job_200k.sh
...
echo "============================================"
echo "  SimForge — 200K Job Started"
echo "============================================"
...
if [ ! -f "modelgen/chicago_model.txt" ]; then
    ...
    echo "Transfer it first: scp modelgen/chicago_model.txt akulap@redhawk.hpc.miamioh.edu:~/SimForge/modelgen/"
    exit 1
fi
...
echo "============================================"
echo "  End:      $(date)"
echo "  Output:   scenarios/chicago_200k_car_transit/"
echo "============================================"
