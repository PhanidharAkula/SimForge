...
|---|---|---|---:|---|---:|
| SUMO | meso | FAIL | n/a | netconvert "Ambiguity in turnarounds" (known arm64 issue per `tests/conftest.py::is_arm64_netconvert_crash`) | n/a |
| SUMO | micro | FAIL | n/a | same | n/a |
