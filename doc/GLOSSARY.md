...
*Cross-reference: see `doc/RESULTS_GUIDE.md` for how each term shows up in the analysis output, `doc/SCENARIO_GENERATION.md` for canonical-schema details, and the thesis methods chapter for the formal definitions.*
