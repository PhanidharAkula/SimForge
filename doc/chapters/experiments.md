...
| --- | --- | --- | --- | --- |
| Stress test | `chicago_1k_car` | SUMO meso, SUMO micro, QarSUMO meso, MATSim meso | 3 (MATSim 2) | **11 runs** |

Total wall-clock on Apple M4 Pro: ~27 s. Every cell completes successfully and every `feasibility_report.json` confirms `feasible_trips == 1000`.
...
Total wall-clock across the 11-run matrix: ~27 s.
